...
class RFM69 {
  public:
	...
	static volatile uint8_t listenModeOn;
	...
	void setListenMode(uint8_t resolutionIdle=RF_LISTEN1_IDLE_RESOL_4100, uint8_t resolutionRx=RF_LISTEN1_RX_RESOL_4100, uint8_t coefIdle=0x75, uint8_t CoefRx=0x05, uint8_t criteria =RF_LISTEN1_CRITERIA_RSSI, uint8_t listenEnd = RF_LISTEN1_END_01 ); // standard 480ms idle, 20ms receiving
	void stopListenMode(byte mode);
    void sleep();
