...
///RF12 Driver version
#define OPTIMIZE_SPI       0  // uncomment this to write to the RFM12B @ 8 Mhz
...
class RFM12B
{
	...
	static const uint8_t DATAMAXLEN;
	...
	void Initialize(uint8_t nodeid, uint8_t freqBand, uint8_t groupid=0xAA, uint8_t txPower=0, uint8_t airKbps=0x06, uint8_t lowVoltageThreshold=RF12_2v75);
